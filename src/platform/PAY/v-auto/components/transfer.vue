			...
			<div class="panel-main box-shadow">
                ...
                <template v-else-if="step === 2">
                     ...
                     <div class="input-amount-warp">
                        ...
                        <input type="number" class="input-amount f-din" v-model="amount" @blur="limitAmountHandel" :placeholder="$i18n('请输入金额')" />
                    </div>
                    <h2 class="title-s1">{{ $i18n("存款编号") }}</h2>
                     <div class="input-amount-warp">
                        <input type="number" class="input-amount f-din" v-model="depositNo" @blur="limitAmountHandel" :maxlength="6" :placeholder="$i18n('请输入存款编号')" />
                    </div>
